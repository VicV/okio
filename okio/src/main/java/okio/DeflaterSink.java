...
/**
 * A sink that uses <a href="http://tools.ietf.org/html/rfc1951">DEFLATE</a> to compress data written to another source.
 *
 * <h3>Sync flush</h3> Aggressive flushing of this stream may result in reduced compression. Each call to {@link #flush} immediately
 * compresses all currently-buffered data; this early compression may be less effective than compression performed without flushing.
 *
 * <p>
 * This is equivalent to using {@link Deflater} with the sync flush option. This class does not offer any partial flush mechanism. For best
